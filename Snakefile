...
rule target:
    input:
        ...
        expand("coverage/matched_ratio_coverage/spikenorm/{sample}_{nfactor}-over-{dfactor}_spikenorm-standard-difference.bw",
               nfactor=FACTORS["numerator"],
               dfactor=FACTORS["denominator"],
               sample=config["matched_samples"]) if config["matched_samples"] and comparisons_si else [],
        expand("coverage/matched_ratio_coverage/libsizenorm/{sample}_{nfactor}-over-{dfactor}_libsizenorm-standard-difference.bw",
               nfactor=FACTORS["numerator"],
               dfactor=FACTORS["denominator"],
               sample=config["matched_samples"]) if config["matched_samples"] and comparisons else [],
